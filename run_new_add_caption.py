...
from src.multimodal_models import ResNetRobertaForPromptFinetuning, add_image_token, FusionContrastiveResNetRobertaForPromptFinetuning, FusionContrastiveResNetBertForPromptFinetuning
